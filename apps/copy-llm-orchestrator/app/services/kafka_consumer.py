...
class OfferReadyConsumer:
    ...
    async def start(self) -> None:
        ...
        self._stopped.clear()
        self._task = asyncio.create_task(self._run(), name="offer-ready-consumer")
        logger.info("kafka_consumer_started", topic=OFFER_READY_TOPIC)
        ...
        try:
            async for message in self._consumer:
                ...
                try:
                    ...
                    await self._pipeline.handle_offer_ready(envelope)
